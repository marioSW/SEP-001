            ...
            <ul class="sidebar-menu">
                ...
                <li class="treeview  active">
                    ...
                    <ul class="treeview-menu">
                        ...
                        <li class="active"><a href="{{ url('oic/person') }}"><i class="fa fa-circle-o"></i> View Persons</a></li>
                ...
                <div class="col-xs-12">
                    ...
                    <div class="box">
                        <div class="box-header">
                            <h3 class="box-title">View All Person Information</h3>
                        </div><!-- /.box-header -->
                        <div class="box-body">
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tr>
                                    ...
                                    <td>{{$person->current_mobile_no}}</td>
									<td>{{$person->sex}}</td>
